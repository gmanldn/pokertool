...
try:
    from src.pokertool.core import Card, Suit, Position
except ImportError:
...
class PokerScreenScraper:
    ...
    def _assign_positions(self, state: TableState):
        ...
        if num_active == 2:  # Heads up
            ...
            positions = [Position.BTN, Position.SB, Position.BB, Position.UTG, Position.UTG1, Position.MP1, Position.MP2, Position.HJ, Position.CO][:num_active]
