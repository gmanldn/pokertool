...
# summary: Auto-labeled purpose for test_screen_scraper.py
# ---
...
class TestPokerScreenScraper:
    ...
    def test_extract_pot_size(self):
        ...
        with patch.object(self.scraper.text_recognizer, 'extract_number', return_value=150.75):
    ...
    def test_extract_seat_info(self):
        ...
        with patch.object(self.scraper, '_is_seat_active', return_value=True):
            with patch.object(self.scraper.text_recognizer, 'extract_number', return_value=1000.0):
    ...
    def test_assign_positions(self):
        ...
        assert dealer_seat.position == Position.BTN
    ...
    def test_calibrate(self):
        ...
        with patch.object(self.scraper, 'extract_pot_size', return_value=0.0):
            with patch.object(self.scraper, 'extract_seat_info') as mock_seats:
                ...
                assert result == True
                assert self.scraper.calibrated == True
...
class TestScreenScraperBridge:
    ...
    def test_convert_to_game_state(self):
        ...
        hero_seat = SeatInfo(1, is_active=True, is_hero=True)
...
class TestIntegration:
    ...
    def test_full_scraping_workflow(self, mock_mss):
        ...
        with patch.object(scraper.text_recognizer, 'extract_number', return_value=100.0):
            with patch.object(scraper.card_recognizer, 'recognize_card', 
                            side_effect=[Card('A', Suit.SPADE), Card('K', Suit.HEART)]):
