...
def launch_main_application() -> int:
    ...
    try:
        ...
        logger.info('Found pokertool.cli module, launching directly')
        return cli_module.main()
    except ImportError as e:
        logger.warning('Could not import pokertool.cli', exception=e)
    ...
    for main_script in possible_mains:
        if main_script.exists():
            logger.info('Found main application script', script=str(main_script))
            ...
            logger.info('Launching main application', command=_log_cmd(cmd))
