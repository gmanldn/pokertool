...
export const BrowserConnectionInfo: MessageFns<BrowserConnectionInfo> = {
  ...
  create(base?: DeepPartial<BrowserConnectionInfo>): BrowserConnectionInfo {
    return BrowserConnectionInfo.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BrowserConnectionInfo>): BrowserConnectionInfo {
    const message = createBaseBrowserConnectionInfo();
...
export const BrowserConnection: MessageFns<BrowserConnection> = {
  ...
  create(base?: DeepPartial<BrowserConnection>): BrowserConnection {
    return BrowserConnection.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BrowserConnection>): BrowserConnection {
    const message = createBaseBrowserConnection();
...
export const ChromePath: MessageFns<ChromePath> = {
  ...
  create(base?: DeepPartial<ChromePath>): ChromePath {
    return ChromePath.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ChromePath>): ChromePath {
    const message = createBaseChromePath();
...
export const BrowserSettings: MessageFns<BrowserSettings> = {
  ...
  create(base?: DeepPartial<BrowserSettings>): BrowserSettings {
    return BrowserSettings.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BrowserSettings>): BrowserSettings {
    const message = createBaseBrowserSettings();
...
export const UpdateBrowserSettingsRequest: MessageFns<UpdateBrowserSettingsRequest> = {
  encode(message: UpdateBrowserSettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.customArgs !== undefined) {
      writer.uint32(58).string(message.customArgs);
    }
    return writer;
  },
  ...
  create(base?: DeepPartial<UpdateBrowserSettingsRequest>): UpdateBrowserSettingsRequest {
    return UpdateBrowserSettingsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UpdateBrowserSettingsRequest>): UpdateBrowserSettingsRequest {
    const message = createBaseUpdateBrowserSettingsRequest();
...
export interface BrowserServiceImplementation<CallContextExt = {}> {
  getBrowserConnectionInfo(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<BrowserConnectionInfo>>;
  testBrowserConnection(
    request: StringRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<BrowserConnection>>;
  discoverBrowser(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<BrowserConnection>>;
  getDetectedChromePath(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<ChromePath>>;
  relaunchChromeDebugMode(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<String>>;
}

export interface BrowserServiceClient<CallOptionsExt = {}> {
  getBrowserConnectionInfo(
  ...
  relaunchChromeDebugMode(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<String>;
}
