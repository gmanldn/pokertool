...
export interface TaskServiceImplementation<CallContextExt = {}> {
  ...
  /** Creates a new task with the given text and optional images */
  newTask(request: NewTaskRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Shows a task with the specified ID */
...
export interface TaskServiceClient<CallOptionsExt = {}> {
  ...
  /** Creates a new task with the given text and optional images */
  newTask(request: DeepPartial<NewTaskRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Shows a task with the specified ID */
