...
export const AuthStateChangedRequest: MessageFns<AuthStateChangedRequest> = {
  ...
  create(base?: DeepPartial<AuthStateChangedRequest>): AuthStateChangedRequest {
    return AuthStateChangedRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<AuthStateChangedRequest>): AuthStateChangedRequest {
    const message = createBaseAuthStateChangedRequest();
...
export const AuthState: MessageFns<AuthState> = {
  ...
  create(base?: DeepPartial<AuthState>): AuthState {
    return AuthState.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<AuthState>): AuthState {
    const message = createBaseAuthState();
    message.user = (object.user !== undefined && object.user !== null) ? UserInfo.fromPartial(object.user) : undefined;
    return message;
  },
...
export const UserOrganization: MessageFns<UserOrganization> = {
  ...
  create(base?: DeepPartial<UserOrganization>): UserOrganization {
...
export const UserOrganizationsResponse: MessageFns<UserOrganizationsResponse> = {
  ...
  create(base?: DeepPartial<UserOrganizationsResponse>): UserOrganizationsResponse {
    return UserOrganizationsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UserOrganizationsResponse>): UserOrganizationsResponse {
    const message = createBaseUserOrganizationsResponse();
...
export const UserOrganizationUpdateRequest: MessageFns<UserOrganizationUpdateRequest> = {
  ...
  create(base?: DeepPartial<UserOrganizationUpdateRequest>): UserOrganizationUpdateRequest {
    return UserOrganizationUpdateRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UserOrganizationUpdateRequest>): UserOrganizationUpdateRequest {
    const message = createBaseUserOrganizationUpdateRequest();
...
export const UserCreditsData: MessageFns<UserCreditsData> = {
  ...
  create(base?: DeepPartial<UserCreditsData>): UserCreditsData {
    return UserCreditsData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UserCreditsData>): UserCreditsData {
    const message = createBaseUserCreditsData();
...
export const GetOrganizationCreditsRequest: MessageFns<GetOrganizationCreditsRequest> = {
  ...
  create(base?: DeepPartial<GetOrganizationCreditsRequest>): GetOrganizationCreditsRequest {
    return GetOrganizationCreditsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetOrganizationCreditsRequest>): GetOrganizationCreditsRequest {
    const message = createBaseGetOrganizationCreditsRequest();
    message.organizationId = object.organizationId ?? "";
    return message;
  },
...
export const OrganizationCreditsData: MessageFns<OrganizationCreditsData> = {
  ...
  create(base?: DeepPartial<OrganizationCreditsData>): OrganizationCreditsData {
    return OrganizationCreditsData.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<OrganizationCreditsData>): OrganizationCreditsData {
    const message = createBaseOrganizationCreditsData();
    message.balance = (object.balance !== undefined && object.balance !== null)
      ? UserCreditsBalance.fromPartial(object.balance)
      : undefined;
...
export const UserCreditsBalance: MessageFns<UserCreditsBalance> = {
  ...
  create(base?: DeepPartial<UserCreditsBalance>): UserCreditsBalance {
    return UserCreditsBalance.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UserCreditsBalance>): UserCreditsBalance {
    const message = createBaseUserCreditsBalance();
...
export const UsageTransaction: MessageFns<UsageTransaction> = {
  ...
  create(base?: DeepPartial<UsageTransaction>): UsageTransaction {
    return UsageTransaction.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UsageTransaction>): UsageTransaction {
    const message = createBaseUsageTransaction();
...
export const PaymentTransaction: MessageFns<PaymentTransaction> = {
  ...
  create(base?: DeepPartial<PaymentTransaction>): PaymentTransaction {
    return PaymentTransaction.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PaymentTransaction>): PaymentTransaction {
    const message = createBasePaymentTransaction();
...
export const OrganizationUsageTransaction: MessageFns<OrganizationUsageTransaction> = {
  ...
  create(base?: DeepPartial<OrganizationUsageTransaction>): OrganizationUsageTransaction {
    return OrganizationUsageTransaction.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<OrganizationUsageTransaction>): OrganizationUsageTransaction {
    const message = createBaseOrganizationUsageTransaction();
    message.aiInferenceProviderName = object.aiInferenceProviderName ?? "";
    message.aiModelName = object.aiModelName ?? "";
    message.aiModelTypeName = object.aiModelTypeName ?? "";
...
export interface AccountServiceImplementation<CallContextExt = {}> {
   ...
   * and opens the authentication URL in the external browser.
   */
  accountLoginClicked(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<String>>;
  /**
   * Handles the user clicking the logout button in the UI.
   * Clears API keys and user state.
   */
  accountLogoutClicked(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Subscribe to auth status update events (when authentication state changes) */
  subscribeToAuthStatusUpdate(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): ServerStreamingMethodResult<DeepPartial<AuthState>>;
  /**
   * Handles authentication state changes from the Firebase context.
   * Updates the user info in global state and returns the updated value.
   */
  authStateChanged(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<AuthState>>;
  /**
   * Fetches all user credits data
   * (balance, usage transactions, payment transactions)
   */
  getUserCredits(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<UserCreditsData>>;
  getOrganizationCredits(
    request: GetOrganizationCreditsRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<OrganizationCreditsData>>;
  /**
   * Fetches all user organizations data
   * Returns a list of UserOrganization objects
   */
  getUserOrganizations(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<UserOrganizationsResponse>>;
  setUserOrganization(
  ...
  /** Returns a link the webview can use to redirect back to the user's IDE. */
  getRedirectUrl(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<String>>;
}
...
export interface AccountServiceClient<CallOptionsExt = {}> {
   ...
   * and opens the authentication URL in the external browser.
   */
  accountLoginClicked(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<String>;
  /**
   * Handles the user clicking the logout button in the UI.
   * Clears API keys and user state.
   */
  accountLogoutClicked(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Subscribe to auth status update events (when authentication state changes) */
  subscribeToAuthStatusUpdate(
    request: DeepPartial<EmptyRequest>,
    options?: CallOptions & CallOptionsExt,
  ): AsyncIterable<AuthState>;
  /**
   * Handles authentication state changes from the Firebase context.
   * Updates the user info in global state and returns the updated value.
   */
  authStateChanged(
    request: DeepPartial<AuthStateChangedRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<AuthState>;
  /**
   * Fetches all user credits data
   * (balance, usage transactions, payment transactions)
   */
  getUserCredits(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<UserCreditsData>;
  getOrganizationCredits(
    request: DeepPartial<GetOrganizationCreditsRequest>,
    options?: CallOptions & CallOptionsExt,
  ...
  /** Returns a link the webview can use to redirect back to the user's IDE. */
  getRedirectUrl(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<String>;
}
