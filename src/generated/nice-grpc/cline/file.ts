...
export const ToggleWindsurfRuleRequest: MessageFns<ToggleWindsurfRuleRequest> = {
  ...
  create(base?: DeepPartial<ToggleWindsurfRuleRequest>): ToggleWindsurfRuleRequest {
    return ToggleWindsurfRuleRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ToggleWindsurfRuleRequest>): ToggleWindsurfRuleRequest {
    const message = createBaseToggleWindsurfRuleRequest();
...
export const ToggleClineRuleRequest: MessageFns<ToggleClineRuleRequest> = {
  ...
  fromPartial(object: DeepPartial<ToggleClineRuleRequest>): ToggleClineRuleRequest {
    const message = createBaseToggleClineRuleRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata.fromPartial(object.metadata)
      : undefined;
...
export const ClineRulesToggles_TogglesEntry: MessageFns<ClineRulesToggles_TogglesEntry> = {
  ...
  create(base?: DeepPartial<ClineRulesToggles_TogglesEntry>): ClineRulesToggles_TogglesEntry {
    return ClineRulesToggles_TogglesEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineRulesToggles_TogglesEntry>): ClineRulesToggles_TogglesEntry {
    const message = createBaseClineRulesToggles_TogglesEntry();
...
export const ToggleCursorRuleRequest: MessageFns<ToggleCursorRuleRequest> = {
  ...
  fromPartial(object: DeepPartial<ToggleCursorRuleRequest>): ToggleCursorRuleRequest {
    const message = createBaseToggleCursorRuleRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata.fromPartial(object.metadata)
      : undefined;
...
export const ToggleWorkflowRequest: MessageFns<ToggleWorkflowRequest> = {
  ...
  fromPartial(object: DeepPartial<ToggleWorkflowRequest>): ToggleWorkflowRequest {
    const message = createBaseToggleWorkflowRequest();
    message.metadata = (object.metadata !== undefined && object.metadata !== null)
      ? Metadata.fromPartial(object.metadata)
      : undefined;
...
export interface FileServiceImplementation<CallContextExt = {}> {
  /** Copies text to clipboard */
  copyToClipboard(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Opens a file in the editor */
  openFile(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Opens an image in the system viewer */
  openImage(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Opens a mention (file, path, git commit, problem, terminal, or URL) */
  openMention(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Deletes a rule file from either global or workspace rules directory */
  deleteRuleFile(request: RuleFileRequest, context: CallContext & CallContextExt): Promise<DeepPartial<RuleFile>>;
  /** Creates a rule file from either global or workspace rules directory */
  createRuleFile(request: RuleFileRequest, context: CallContext & CallContextExt): Promise<DeepPartial<RuleFile>>;
  /** Search git commits in the workspace */
  searchCommits(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<GitCommits>>;
  /** Select images and other files from the file system and returns as data URLs & paths respectively */
  selectFiles(request: BooleanRequest, context: CallContext & CallContextExt): Promise<DeepPartial<StringArrays>>;
  /** Convert URIs to workspace-relative paths */
  getRelativePaths(
  ...
  /** Refreshes all rule toggles (Cline, External, and Workflows) */
  refreshRules(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<RefreshedRules>>;
  /** Opens a task's conversation history file on disk */
  openTaskHistory(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Toggles a workflow on or off */
  toggleWorkflow(
  ...
  /** Open a file in editor by a relative path */
  openFileRelativePath(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Opens or creates a focus chain checklist markdown file for editing */
  openFocusChainFile(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
}

export interface FileServiceClient<CallOptionsExt = {}> {
  /** Copies text to clipboard */
  copyToClipboard(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Opens a file in the editor */
  openFile(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Opens an image in the system viewer */
  openImage(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Opens a mention (file, path, git commit, problem, terminal, or URL) */
  openMention(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Deletes a rule file from either global or workspace rules directory */
  deleteRuleFile(request: DeepPartial<RuleFileRequest>, options?: CallOptions & CallOptionsExt): Promise<RuleFile>;
  /** Creates a rule file from either global or workspace rules directory */
  createRuleFile(request: DeepPartial<RuleFileRequest>, options?: CallOptions & CallOptionsExt): Promise<RuleFile>;
  /** Search git commits in the workspace */
  searchCommits(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<GitCommits>;
  /** Select images and other files from the file system and returns as data URLs & paths respectively */
  selectFiles(request: DeepPartial<BooleanRequest>, options?: CallOptions & CallOptionsExt): Promise<StringArrays>;
  /** Convert URIs to workspace-relative paths */
  getRelativePaths(
  ...
  /** Refreshes all rule toggles (Cline, External, and Workflows) */
  refreshRules(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<RefreshedRules>;
  /** Opens a task's conversation history file on disk */
  openTaskHistory(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Toggles a workflow on or off */
  toggleWorkflow(
  ...
  /** Open a file in editor by a relative path */
  openFileRelativePath(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Opens or creates a focus chain checklist markdown file for editing */
  openFocusChainFile(request: DeepPartial<StringRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
}
