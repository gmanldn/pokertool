...
export const BrowserSettingsUpdate: MessageFns<BrowserSettingsUpdate> = {
  ...
  create(base?: DeepPartial<BrowserSettingsUpdate>): BrowserSettingsUpdate {
    return BrowserSettingsUpdate.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BrowserSettingsUpdate>): BrowserSettingsUpdate {
    const message = createBaseBrowserSettingsUpdate();
...
export const ApiConfiguration_OpenAiHeadersEntry: MessageFns<ApiConfiguration_OpenAiHeadersEntry> = {
  ...
  create(base?: DeepPartial<ApiConfiguration_OpenAiHeadersEntry>): ApiConfiguration_OpenAiHeadersEntry {
    return ApiConfiguration_OpenAiHeadersEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ApiConfiguration_OpenAiHeadersEntry>): ApiConfiguration_OpenAiHeadersEntry {
    const message = createBaseApiConfiguration_OpenAiHeadersEntry();
