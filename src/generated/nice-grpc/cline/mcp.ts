...
export const McpMarketplaceItem: MessageFns<McpMarketplaceItem> = {
  ...
  create(base?: DeepPartial<McpMarketplaceItem>): McpMarketplaceItem {
    return McpMarketplaceItem.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<McpMarketplaceItem>): McpMarketplaceItem {
    const message = createBaseMcpMarketplaceItem();
...
export const McpMarketplaceCatalog: MessageFns<McpMarketplaceCatalog> = {
  ...
  create(base?: DeepPartial<McpMarketplaceCatalog>): McpMarketplaceCatalog {
    return McpMarketplaceCatalog.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<McpMarketplaceCatalog>): McpMarketplaceCatalog {
    const message = createBaseMcpMarketplaceCatalog();
...
export const McpDownloadResponse: MessageFns<McpDownloadResponse> = {
  ...
  create(base?: DeepPartial<McpDownloadResponse>): McpDownloadResponse {
    return McpDownloadResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<McpDownloadResponse>): McpDownloadResponse {
    const message = createBaseMcpDownloadResponse();
    message.mcpId = object.mcpId ?? "";
    message.githubUrl = object.githubUrl ?? "";
    message.name = object.name ?? "";
...
export interface McpServiceImplementation<CallContextExt = {}> {
  ...
  downloadMcp(request: StringRequest, context: CallContext & CallContextExt): Promise<DeepPartial<McpDownloadResponse>>;
  ...
  refreshMcpMarketplace(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<McpMarketplaceCatalog>>;
  openMcpSettings(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Subscribe to MCP marketplace catalog updates */
  subscribeToMcpMarketplaceCatalog(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): ServerStreamingMethodResult<DeepPartial<McpMarketplaceCatalog>>;
...
export interface McpServiceClient<CallOptionsExt = {}> {
  ...
  subscribeToMcpMarketplaceCatalog(
    request: DeepPartial<EmptyRequest>,
    options?: CallOptions & CallOptionsExt,
  ): AsyncIterable<McpMarketplaceCatalog>;
