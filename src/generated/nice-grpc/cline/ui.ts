...
export const WebviewProviderTypeRequest: MessageFns<WebviewProviderTypeRequest> = {
  ...
  create(base?: DeepPartial<WebviewProviderTypeRequest>): WebviewProviderTypeRequest {
    return WebviewProviderTypeRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<WebviewProviderTypeRequest>): WebviewProviderTypeRequest {
    const message = createBaseWebviewProviderTypeRequest();
...
export const ClineSayTool: MessageFns<ClineSayTool> = {
  ...
  create(base?: DeepPartial<ClineSayTool>): ClineSayTool {
    return ClineSayTool.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineSayTool>): ClineSayTool {
    const message = createBaseClineSayTool();
...
export const ClineSayBrowserAction: MessageFns<ClineSayBrowserAction> = {
  ...
  create(base?: DeepPartial<ClineSayBrowserAction>): ClineSayBrowserAction {
    return ClineSayBrowserAction.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineSayBrowserAction>): ClineSayBrowserAction {
    const message = createBaseClineSayBrowserAction();
...
export const ClineAskUseMcpServer: MessageFns<ClineAskUseMcpServer> = {
  ...
  create(base?: DeepPartial<ClineAskUseMcpServer>): ClineAskUseMcpServer {
    return ClineAskUseMcpServer.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineAskUseMcpServer>): ClineAskUseMcpServer {
    const message = createBaseClineAskUseMcpServer();
...
export const ClinePlanModeResponse: MessageFns<ClinePlanModeResponse> = {
  ...
  create(base?: DeepPartial<ClinePlanModeResponse>): ClinePlanModeResponse {
    return ClinePlanModeResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClinePlanModeResponse>): ClinePlanModeResponse {
    const message = createBaseClinePlanModeResponse();
...
export const ClineAskQuestion: MessageFns<ClineAskQuestion> = {
  ...
  create(base?: DeepPartial<ClineAskQuestion>): ClineAskQuestion {
    return ClineAskQuestion.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineAskQuestion>): ClineAskQuestion {
    const message = createBaseClineAskQuestion();
...
export const ClineAskNewTask: MessageFns<ClineAskNewTask> = {
  ...
  create(base?: DeepPartial<ClineAskNewTask>): ClineAskNewTask {
    return ClineAskNewTask.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineAskNewTask>): ClineAskNewTask {
    const message = createBaseClineAskNewTask();
...
export const ClineApiReqInfo: MessageFns<ClineApiReqInfo> = {
  ...
  create(base?: DeepPartial<ClineApiReqInfo>): ClineApiReqInfo {
    return ClineApiReqInfo.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineApiReqInfo>): ClineApiReqInfo {
    const message = createBaseClineApiReqInfo();
...
export const ClineMessage: MessageFns<ClineMessage> = {
  ...
  create(base?: DeepPartial<ClineMessage>): ClineMessage {
    return ClineMessage.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ClineMessage>): ClineMessage {
    const message = createBaseClineMessage();
...
export interface UiServiceImplementation<CallContextExt = {}> {
  ...
  subscribeToPartialMessage(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): ServerStreamingMethodResult<DeepPartial<ClineMessage>>;
  /** Initialize webview when it launches */
...
export interface UiServiceClient<CallOptionsExt = {}> {
  ...
  /** Subscribe to MCP button clicked events */
  subscribeToMcpButtonClicked(
    request: DeepPartial<WebviewProviderTypeRequest>,
    options?: CallOptions & CallOptionsExt,
  ): AsyncIterable<Empty>;
  /** Subscribe to history button click events */
  subscribeToHistoryButtonClicked(
