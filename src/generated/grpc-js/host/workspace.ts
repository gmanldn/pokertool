...
export const WorkspaceServiceService = {
  ...
  getWorkspacePaths: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetWorkspacePathsRequest) => Buffer.from(GetWorkspacePathsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetWorkspacePathsRequest.decode(value),
    responseSerialize: (value: GetWorkspacePathsResponse) =>
      Buffer.from(GetWorkspacePathsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetWorkspacePathsResponse.decode(value),
  },
  /**
   * Saves an open document if it's open in the editor and has unsaved changes.
   * Returns true if the document was saved, returns false if the document was not found, or did not
  ...
  saveOpenDocumentIfDirty: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SaveOpenDocumentIfDirtyRequest) =>
      Buffer.from(SaveOpenDocumentIfDirtyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SaveOpenDocumentIfDirtyRequest.decode(value),
    responseSerialize: (value: SaveOpenDocumentIfDirtyResponse) =>
      Buffer.from(SaveOpenDocumentIfDirtyResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SaveOpenDocumentIfDirtyResponse.decode(value),
  },
  /** Get diagnostics from the workspace. */
  getDiagnostics: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetDiagnosticsRequest) => Buffer.from(GetDiagnosticsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetDiagnosticsRequest.decode(value),
    responseSerialize: (value: GetDiagnosticsResponse) => Buffer.from(GetDiagnosticsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetDiagnosticsResponse.decode(value),
  },
  /** Makes the problems panel/pane visible in the IDE and focuses it. */
  openProblemsPanel: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenProblemsPanelRequest) => Buffer.from(OpenProblemsPanelRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => OpenProblemsPanelRequest.decode(value),
    responseSerialize: (value: OpenProblemsPanelResponse) =>
      Buffer.from(OpenProblemsPanelResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OpenProblemsPanelResponse.decode(value),
  },
  /** Opens the IDE file explorer panel and selects a file or directory. */
  openInFileExplorerPanel: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenInFileExplorerPanelRequest) =>
      Buffer.from(OpenInFileExplorerPanelRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => OpenInFileExplorerPanelRequest.decode(value),
    responseSerialize: (value: OpenInFileExplorerPanelResponse) =>
      Buffer.from(OpenInFileExplorerPanelResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OpenInFileExplorerPanelResponse.decode(value),
  },
  /** Opens and focuses the Cline sidebar panel in the host IDE. */
  openClineSidebarPanel: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenClineSidebarPanelRequest) =>
      Buffer.from(OpenClineSidebarPanelRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => OpenClineSidebarPanelRequest.decode(value),
    responseSerialize: (value: OpenClineSidebarPanelResponse) =>
      Buffer.from(OpenClineSidebarPanelResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OpenClineSidebarPanelResponse.decode(value),
  },
} as const;
...
export interface WorkspaceServiceServer extends UntypedServiceImplementation {
  ...
  /** Opens the IDE file explorer panel and selects a file or directory. */
  openInFileExplorerPanel: handleUnaryCall<OpenInFileExplorerPanelRequest, OpenInFileExplorerPanelResponse>;
  /** Opens and focuses the Cline sidebar panel in the host IDE. */
  openClineSidebarPanel: handleUnaryCall<OpenClineSidebarPanelRequest, OpenClineSidebarPanelResponse>;
}
...
export interface WorkspaceServiceClient extends Client {
  ...
  getWorkspacePaths(
    ...
    callback: (error: ServiceError | null, response: GetWorkspacePathsResponse) => void,
  ): ClientUnaryCall;
  getWorkspacePaths(
    request: GetWorkspacePathsRequest,
    metadata: Metadata,
  ...
  saveOpenDocumentIfDirty(
    ...
    callback: (error: ServiceError | null, response: SaveOpenDocumentIfDirtyResponse) => void,
  ): ClientUnaryCall;
  saveOpenDocumentIfDirty(
    request: SaveOpenDocumentIfDirtyRequest,
    metadata: Metadata,
  ...
  getDiagnostics(
    ...
    callback: (error: ServiceError | null, response: GetDiagnosticsResponse) => void,
  ): ClientUnaryCall;
  getDiagnostics(
    request: GetDiagnosticsRequest,
    metadata: Metadata,
  ...
  openProblemsPanel(
    ...
    callback: (error: ServiceError | null, response: OpenProblemsPanelResponse) => void,
  ): ClientUnaryCall;
  openProblemsPanel(
    request: OpenProblemsPanelRequest,
    metadata: Metadata,
  ...
  openInFileExplorerPanel(
    ...
    callback: (error: ServiceError | null, response: OpenInFileExplorerPanelResponse) => void,
  ): ClientUnaryCall;
  openInFileExplorerPanel(
    request: OpenInFileExplorerPanelRequest,
    metadata: Metadata,
  ...
  openClineSidebarPanel(
    ...
    callback: (error: ServiceError | null, response: OpenClineSidebarPanelResponse) => void,
  ): ClientUnaryCall;
  openClineSidebarPanel(
    request: OpenClineSidebarPanelRequest,
    metadata: Metadata,
