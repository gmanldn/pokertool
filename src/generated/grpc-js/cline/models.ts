...
export const ModelsServiceService = {
  ...
  getOllamaModels: {
    ...
    responseSerialize: (value: StringArray) => Buffer.from(StringArray.encode(value).finish()),
    responseDeserialize: (value: Buffer) => StringArray.decode(value),
  },
  /** Fetches available models from LM Studio */
  getLmStudioModels: {
  ...
  getVsCodeLmModels: {
    ...
    responseSerialize: (value: VsCodeLmModelsArray) => Buffer.from(VsCodeLmModelsArray.encode(value).finish()),
    responseDeserialize: (value: Buffer) => VsCodeLmModelsArray.decode(value),
  },
  /** Refreshes and returns OpenRouter models */
  refreshOpenRouterModels: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: OpenRouterCompatibleModelInfo) =>
      Buffer.from(OpenRouterCompatibleModelInfo.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OpenRouterCompatibleModelInfo.decode(value),
  },
  /** Refreshes and returns Hugging Face models */
  refreshHuggingFaceModels: {
  ...
  refreshOpenAiModels: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: OpenAiModelsRequest) => Buffer.from(OpenAiModelsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => OpenAiModelsRequest.decode(value),
    responseSerialize: (value: StringArray) => Buffer.from(StringArray.encode(value).finish()),
    responseDeserialize: (value: Buffer) => StringArray.decode(value),
  },
  /** Refreshes and returns Vercel AI Gateway models */
  ...
  updateApiConfigurationProto: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateApiConfigurationRequest) =>
      Buffer.from(UpdateApiConfigurationRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UpdateApiConfigurationRequest.decode(value),
  ...
  getSapAiCoreModels: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: SapAiCoreModelsRequest) => Buffer.from(SapAiCoreModelsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => SapAiCoreModelsRequest.decode(value),
    responseSerialize: (value: SapAiCoreModelsResponse) => Buffer.from(SapAiCoreModelsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => SapAiCoreModelsResponse.decode(value),
  },
  /** Fetches available models from OCA */
  refreshOcaModels: {
    ...
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
    responseSerialize: (value: OcaCompatibleModelInfo) => Buffer.from(OcaCompatibleModelInfo.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OcaCompatibleModelInfo.decode(value),
  },
} as const;
...
export interface ModelsServiceServer extends UntypedServiceImplementation {
  ...
  /** Refreshes and returns Vercel AI Gateway models */
  refreshVercelAiGatewayModels: handleUnaryCall<EmptyRequest, OpenRouterCompatibleModelInfo>;
  /** Refreshes and returns Requesty models */
