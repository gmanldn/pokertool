...
export const TaskServiceService = {
  ...
  getTotalTasksSize: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: Int64) => Buffer.from(Int64.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Int64.decode(value),
  },
  /** Deletes multiple tasks with the given IDs */
  deleteTasksWithIds: {
    path: "/cline.TaskService/deleteTasksWithIds",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringArrayRequest) => Buffer.from(StringArrayRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringArrayRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  /** Creates a new task with the given text and optional images */
  ...
  /** Shows a task with the specified ID */
  showTaskWithId: {
    path: "/cline.TaskService/showTaskWithId",
    requestStream: false,
    responseStream: false,
    ...
    responseSerialize: (value: TaskResponse) => Buffer.from(TaskResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => TaskResponse.decode(value),
  },
  /** Exports a task with the given ID to markdown */
  exportTaskWithId: {
    path: "/cline.TaskService/exportTaskWithId",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
  ...
  /** Toggles the favorite status of a task */
  toggleTaskFavorite: {
    path: "/cline.TaskService/toggleTaskFavorite",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: TaskFavoriteRequest) => Buffer.from(TaskFavoriteRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => TaskFavoriteRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  /** Gets filtered task history */
  getTaskHistory: {
    path: "/cline.TaskService/getTaskHistory",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetTaskHistoryRequest) => Buffer.from(GetTaskHistoryRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetTaskHistoryRequest.decode(value),
    responseSerialize: (value: TaskHistoryArray) => Buffer.from(TaskHistoryArray.encode(value).finish()),
    responseDeserialize: (value: Buffer) => TaskHistoryArray.decode(value),
  },
  /** Sends a response to a previous ask operation */
  askResponse: {
    path: "/cline.TaskService/askResponse",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: AskResponseRequest) => Buffer.from(AskResponseRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => AskResponseRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  /** Records task feedback (thumbs up/down) */
  taskFeedback: {
    path: "/cline.TaskService/taskFeedback",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
  ...
  /** Executes a quick win task with command and title */
  executeQuickWin: {
    path: "/cline.TaskService/executeQuickWin",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ExecuteQuickWinRequest) => Buffer.from(ExecuteQuickWinRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ExecuteQuickWinRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  /** Deletes all task history */
  deleteAllTaskHistory: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: DeleteAllTaskHistoryCount) =>
      Buffer.from(DeleteAllTaskHistoryCount.encode(value).finish()),
    responseDeserialize: (value: Buffer) => DeleteAllTaskHistoryCount.decode(value),
  },
} as const;
...
export interface TaskServiceServer extends UntypedServiceImplementation {
  ...
  /** Gets the total size of all tasks */
  getTotalTasksSize: handleUnaryCall<EmptyRequest, Int64>;
  /** Deletes multiple tasks with the given IDs */
  deleteTasksWithIds: handleUnaryCall<StringArrayRequest, Empty>;
  /** Creates a new task with the given text and optional images */
  newTask: handleUnaryCall<NewTaskRequest, Empty>;
  /** Shows a task with the specified ID */
  showTaskWithId: handleUnaryCall<StringRequest, TaskResponse>;
  /** Exports a task with the given ID to markdown */
  exportTaskWithId: handleUnaryCall<StringRequest, Empty>;
  /** Toggles the favorite status of a task */
  toggleTaskFavorite: handleUnaryCall<TaskFavoriteRequest, Empty>;
  /** Gets filtered task history */
  getTaskHistory: handleUnaryCall<GetTaskHistoryRequest, TaskHistoryArray>;
  /** Sends a response to a previous ask operation */
  askResponse: handleUnaryCall<AskResponseRequest, Empty>;
  /** Records task feedback (thumbs up/down) */
  taskFeedback: handleUnaryCall<StringRequest, Empty>;
  /** Shows task completion changes diff in a view */
  taskCompletionViewChanges: handleUnaryCall<Int64Request, Empty>;
  /** Executes a quick win task with command and title */
  executeQuickWin: handleUnaryCall<ExecuteQuickWinRequest, Empty>;
  /** Deletes all task history */
  deleteAllTaskHistory: handleUnaryCall<EmptyRequest, DeleteAllTaskHistoryCount>;
}
...
export interface TaskServiceClient extends Client {
  ...
  getTaskHistory(
    ...
    callback: (error: ServiceError | null, response: TaskHistoryArray) => void,
  ): ClientUnaryCall;
  getTaskHistory(
    request: GetTaskHistoryRequest,
    metadata: Metadata,
  ...
  deleteAllTaskHistory(
    request: EmptyRequest,
    callback: (error: ServiceError | null, response: DeleteAllTaskHistoryCount) => void,
  ): ClientUnaryCall;
  deleteAllTaskHistory(
    request: EmptyRequest,
    metadata: Metadata,
