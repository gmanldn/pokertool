...
function createBaseFileSearchRequest(): FileSearchRequest {
  return { metadata: undefined, query: "", mentionsRequestId: undefined, limit: undefined, selectedType: undefined };
}
...
export const FileSearchRequest: MessageFns<FileSearchRequest> = {
  ...
  fromJSON(object: any): FileSearchRequest {
    return {
      ...
      selectedType: isSet(object.selectedType) ? fileSearchTypeFromJSON(object.selectedType) : undefined,
    };
  },
...
export const FileServiceService = {
  /** Copies text to clipboard */
  copyToClipboard: {
    path: "/cline.FileService/copyToClipboard",
    requestStream: false,
    responseStream: false,
  ...
  /** Opens a mention (file, path, git commit, problem, terminal, or URL) */
  openMention: {
    path: "/cline.FileService/openMention",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
  ...
  selectFiles: {
    ...
    responseSerialize: (value: StringArrays) => Buffer.from(StringArrays.encode(value).finish()),
    responseDeserialize: (value: Buffer) => StringArrays.decode(value),
  },
  /** Convert URIs to workspace-relative paths */
  getRelativePaths: {
    path: "/cline.FileService/getRelativePaths",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: RelativePathsRequest) => Buffer.from(RelativePathsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => RelativePathsRequest.decode(value),
    responseSerialize: (value: RelativePaths) => Buffer.from(RelativePaths.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RelativePaths.decode(value),
  },
  /** Search for files in the workspace with fuzzy matching */
  searchFiles: {
    path: "/cline.FileService/searchFiles",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: FileSearchRequest) => Buffer.from(FileSearchRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => FileSearchRequest.decode(value),
    responseSerialize: (value: FileSearchResults) => Buffer.from(FileSearchResults.encode(value).finish()),
    responseDeserialize: (value: Buffer) => FileSearchResults.decode(value),
  },
  /** Toggle a Cline rule (enable or disable) */
  toggleClineRule: {
    path: "/cline.FileService/toggleClineRule",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleClineRuleRequest) => Buffer.from(ToggleClineRuleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ToggleClineRuleRequest.decode(value),
    responseSerialize: (value: ToggleClineRules) => Buffer.from(ToggleClineRules.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ToggleClineRules.decode(value),
  },
  /** Toggle a Cursor rule (enable or disable) */
  toggleCursorRule: {
    path: "/cline.FileService/toggleCursorRule",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleCursorRuleRequest) => Buffer.from(ToggleCursorRuleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ToggleCursorRuleRequest.decode(value),
    responseSerialize: (value: ClineRulesToggles) => Buffer.from(ClineRulesToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ClineRulesToggles.decode(value),
  },
  /** Toggle a Windsurf rule (enable or disable) */
  toggleWindsurfRule: {
    path: "/cline.FileService/toggleWindsurfRule",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleWindsurfRuleRequest) =>
      Buffer.from(ToggleWindsurfRuleRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ToggleWindsurfRuleRequest.decode(value),
    responseSerialize: (value: ClineRulesToggles) => Buffer.from(ClineRulesToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ClineRulesToggles.decode(value),
  },
  /** Refreshes all rule toggles (Cline, External, and Workflows) */
  refreshRules: {
    ...
    responseSerialize: (value: RefreshedRules) => Buffer.from(RefreshedRules.encode(value).finish()),
    responseDeserialize: (value: Buffer) => RefreshedRules.decode(value),
  },
  /** Opens a task's conversation history file on disk */
  openTaskHistory: {
    path: "/cline.FileService/openTaskHistory",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
  ...
  /** Toggles a workflow on or off */
  toggleWorkflow: {
    path: "/cline.FileService/toggleWorkflow",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ToggleWorkflowRequest) => Buffer.from(ToggleWorkflowRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => ToggleWorkflowRequest.decode(value),
    responseSerialize: (value: ClineRulesToggles) => Buffer.from(ClineRulesToggles.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ClineRulesToggles.decode(value),
  },
  /** Check if file exists in the project */
  ifFileExistsRelativePath: {
    path: "/cline.FileService/ifFileExistsRelativePath",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
    responseSerialize: (value: BooleanResponse) => Buffer.from(BooleanResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => BooleanResponse.decode(value),
  },
  /** Open a file in editor by a relative path */
  openFileRelativePath: {
    path: "/cline.FileService/openFileRelativePath",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
  ...
  /** Opens or creates a focus chain checklist markdown file for editing */
  openFocusChainFile: {
    path: "/cline.FileService/openFocusChainFile",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: StringRequest) => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => StringRequest.decode(value),
...
export interface FileServiceServer extends UntypedServiceImplementation {
  /** Copies text to clipboard */
  copyToClipboard: handleUnaryCall<StringRequest, Empty>;
  /** Opens a file in the editor */
  openFile: handleUnaryCall<StringRequest, Empty>;
  /** Opens an image in the system viewer */
  openImage: handleUnaryCall<StringRequest, Empty>;
  /** Opens a mention (file, path, git commit, problem, terminal, or URL) */
  openMention: handleUnaryCall<StringRequest, Empty>;
  /** Deletes a rule file from either global or workspace rules directory */
  ...
  /** Select images and other files from the file system and returns as data URLs & paths respectively */
  selectFiles: handleUnaryCall<BooleanRequest, StringArrays>;
  /** Convert URIs to workspace-relative paths */
  getRelativePaths: handleUnaryCall<RelativePathsRequest, RelativePaths>;
  /** Search for files in the workspace with fuzzy matching */
  searchFiles: handleUnaryCall<FileSearchRequest, FileSearchResults>;
  /** Toggle a Cline rule (enable or disable) */
  toggleClineRule: handleUnaryCall<ToggleClineRuleRequest, ToggleClineRules>;
  /** Toggle a Cursor rule (enable or disable) */
  toggleCursorRule: handleUnaryCall<ToggleCursorRuleRequest, ClineRulesToggles>;
  /** Toggle a Windsurf rule (enable or disable) */
  toggleWindsurfRule: handleUnaryCall<ToggleWindsurfRuleRequest, ClineRulesToggles>;
  /** Refreshes all rule toggles (Cline, External, and Workflows) */
  refreshRules: handleUnaryCall<EmptyRequest, RefreshedRules>;
  /** Opens a task's conversation history file on disk */
  openTaskHistory: handleUnaryCall<StringRequest, Empty>;
  /** Toggles a workflow on or off */
  toggleWorkflow: handleUnaryCall<ToggleWorkflowRequest, ClineRulesToggles>;
  /** Check if file exists in the project */
  ifFileExistsRelativePath: handleUnaryCall<StringRequest, BooleanResponse>;
  /** Open a file in editor by a relative path */
  openFileRelativePath: handleUnaryCall<StringRequest, Empty>;
  /** Opens or creates a focus chain checklist markdown file for editing */
  openFocusChainFile: handleUnaryCall<StringRequest, Empty>;
}
...
export interface FileServiceClient extends Client {
  ...
  /** Opens a mention (file, path, git commit, problem, terminal, or URL) */
  openMention(request: StringRequest, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  openMention(
    request: StringRequest,
    metadata: Metadata,
    callback: (error: ServiceError | null, response: Empty) => void,
  ...
  selectFiles(
    ...
    callback: (error: ServiceError | null, response: StringArrays) => void,
  ): ClientUnaryCall;
  selectFiles(
    request: BooleanRequest,
    metadata: Metadata,
  ...
  getRelativePaths(
    ...
    callback: (error: ServiceError | null, response: RelativePaths) => void,
  ): ClientUnaryCall;
  getRelativePaths(
    request: RelativePathsRequest,
    metadata: Metadata,
  ...
  searchFiles(
    ...
    callback: (error: ServiceError | null, response: FileSearchResults) => void,
  ): ClientUnaryCall;
  searchFiles(
    request: FileSearchRequest,
    metadata: Metadata,
  ...
  toggleClineRule(
    ...
    callback: (error: ServiceError | null, response: ToggleClineRules) => void,
  ): ClientUnaryCall;
  toggleClineRule(
    request: ToggleClineRuleRequest,
    metadata: Metadata,
  ...
  toggleCursorRule(
    ...
    callback: (error: ServiceError | null, response: ClineRulesToggles) => void,
  ): ClientUnaryCall;
  toggleCursorRule(
    request: ToggleCursorRuleRequest,
    metadata: Metadata,
  ...
  refreshRules(
    ...
    callback: (error: ServiceError | null, response: RefreshedRules) => void,
  ): ClientUnaryCall;
  refreshRules(
    request: EmptyRequest,
    metadata: Metadata,
  ...
  ifFileExistsRelativePath(
    request: StringRequest,
    callback: (error: ServiceError | null, response: BooleanResponse) => void,
  ): ClientUnaryCall;
  ifFileExistsRelativePath(
    request: StringRequest,
    metadata: Metadata,
