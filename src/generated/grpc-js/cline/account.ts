...
import { Empty, EmptyRequest, Metadata as Metadata1, String } from "./common";
...
export const AccountServiceService = {
  ...
  subscribeToAuthStatusUpdate: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: AuthState) => Buffer.from(AuthState.encode(value).finish()),
    responseDeserialize: (value: Buffer) => AuthState.decode(value),
  },
  /**
   * Handles authentication state changes from the Firebase context.
   * Updates the user info in global state and returns the updated value.
  ...
  getUserCredits: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: UserCreditsData) => Buffer.from(UserCreditsData.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UserCreditsData.decode(value),
  },
  getOrganizationCredits: {
    path: "/cline.AccountService/getOrganizationCredits",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetOrganizationCreditsRequest) =>
      Buffer.from(GetOrganizationCreditsRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetOrganizationCreditsRequest.decode(value),
    responseSerialize: (value: OrganizationCreditsData) => Buffer.from(OrganizationCreditsData.encode(value).finish()),
    responseDeserialize: (value: Buffer) => OrganizationCreditsData.decode(value),
  },
  /**
   * Fetches all user organizations data
   * Returns a list of UserOrganization objects
  ...
  getUserOrganizations: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: UserOrganizationsResponse) =>
      Buffer.from(UserOrganizationsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => UserOrganizationsResponse.decode(value),
  },
  setUserOrganization: {
    path: "/cline.AccountService/setUserOrganization",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UserOrganizationUpdateRequest) =>
      Buffer.from(UserOrganizationUpdateRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => UserOrganizationUpdateRequest.decode(value),
    responseSerialize: (value: Empty) => Buffer.from(Empty.encode(value).finish()),
    responseDeserialize: (value: Buffer) => Empty.decode(value),
  },
  openrouterAuthClicked: {
