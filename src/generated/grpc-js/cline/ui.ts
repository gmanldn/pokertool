...
import { Boolean, Empty, EmptyRequest, KeyValuePair, Metadata as Metadata1, String, StringRequest } from "./common";
...
/** UiService provides methods for managing UI interactions */
export type UiServiceService = typeof UiServiceService;
export const UiServiceService = {
  /** Scrolls to a specific settings section in the settings view */
  scrollToSettings: {
    path: "/cline.UiService/scrollToSettings",
    requestStream: false,
    responseStream: false,
    ...
    responseSerialize: (value: KeyValuePair) => Buffer.from(KeyValuePair.encode(value).finish()),
    responseDeserialize: (value: Buffer) => KeyValuePair.decode(value),
  },
  /** Marks the current announcement as shown and returns whether an announcement should still be shown */
  onDidShowAnnouncement: {
  ...
  subscribeToMcpButtonClicked: {
    ...
    requestStream: false,
    responseStream: true,
    requestSerialize: (value: WebviewProviderTypeRequest) =>
      Buffer.from(WebviewProviderTypeRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => WebviewProviderTypeRequest.decode(value),
  ...
  subscribeToPartialMessage: {
    ...
    requestSerialize: (value: EmptyRequest) => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => EmptyRequest.decode(value),
    responseSerialize: (value: ClineMessage) => Buffer.from(ClineMessage.encode(value).finish()),
    responseDeserialize: (value: Buffer) => ClineMessage.decode(value),
  },
  /** Initialize webview when it launches */
  initializeWebview: {
...
export interface UiServiceServer extends UntypedServiceImplementation {
  /** Scrolls to a specific settings section in the settings view */
  scrollToSettings: handleUnaryCall<StringRequest, KeyValuePair>;
  /** Marks the current announcement as shown and returns whether an announcement should still be shown */
  onDidShowAnnouncement: handleUnaryCall<EmptyRequest, Boolean>;
  /** Subscribe to addToInput events (when user adds content via context menu) */
  subscribeToAddToInput: handleServerStreamingCall<StringRequest, String>;
  /** Subscribe to MCP button clicked events */
  subscribeToMcpButtonClicked: handleServerStreamingCall<WebviewProviderTypeRequest, Empty>;
  /** Subscribe to history button click events */
  subscribeToHistoryButtonClicked: handleServerStreamingCall<WebviewProviderTypeRequest, Empty>;
  /** Subscribe to chat button clicked events (when the chat button is clicked in VSCode) */
  subscribeToChatButtonClicked: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to account button click events */
  subscribeToAccountButtonClicked: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to settings button clicked events */
  subscribeToSettingsButtonClicked: handleServerStreamingCall<WebviewProviderTypeRequest, Empty>;
  /** Subscribe to partial message updates (streaming Cline messages as they're built) */
  subscribeToPartialMessage: handleServerStreamingCall<EmptyRequest, ClineMessage>;
  /** Initialize webview when it launches */
  initializeWebview: handleUnaryCall<EmptyRequest, Empty>;
  /** Subscribe to relinquish control events */
  subscribeToRelinquishControl: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to focus chat input events with client ID */
  subscribeToFocusChatInput: handleServerStreamingCall<StringRequest, Empty>;
  /** Subscribe to webview visibility change events */
  subscribeToDidBecomeVisible: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Returns the HTML for the webview index page. This is only used by external clients, not by the vscode webview. */
  getWebviewHtml: handleUnaryCall<EmptyRequest, String>;
  /** Opens a URL in the default browser */
  openUrl: handleUnaryCall<StringRequest, Empty>;
  /** Opens the Cline walkthrough */
  openWalkthrough: handleUnaryCall<EmptyRequest, Empty>;
}

export interface UiServiceClient extends Client {
  /** Scrolls to a specific settings section in the settings view */
  scrollToSettings(
    request: StringRequest,
    callback: (error: ServiceError | null, response: KeyValuePair) => void,
  ): ClientUnaryCall;
  scrollToSettings(
    request: StringRequest,
    metadata: Metadata,
  ...
  /** Subscribe to addToInput events (when user adds content via context menu) */
  subscribeToAddToInput(request: StringRequest, options?: Partial<CallOptions>): ClientReadableStream<String>;
  subscribeToAddToInput(
    request: StringRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ): ClientReadableStream<String>;
  /** Subscribe to MCP button clicked events */
  subscribeToMcpButtonClicked(
  ...
  /** Subscribe to chat button clicked events (when the chat button is clicked in VSCode) */
  subscribeToChatButtonClicked(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToChatButtonClicked(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ...
  /** Subscribe to account button click events */
  subscribeToAccountButtonClicked(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToAccountButtonClicked(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ...
  /** Subscribe to partial message updates (streaming Cline messages as they're built) */
  subscribeToPartialMessage(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<ClineMessage>;
  subscribeToPartialMessage(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ): ClientReadableStream<ClineMessage>;
  /** Initialize webview when it launches */
  initializeWebview(
    request: EmptyRequest,
  ...
  /** Subscribe to relinquish control events */
  subscribeToRelinquishControl(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToRelinquishControl(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ...
  /** Subscribe to focus chat input events with client ID */
  subscribeToFocusChatInput(request: StringRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToFocusChatInput(
    request: StringRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ...
  /** Subscribe to webview visibility change events */
  subscribeToDidBecomeVisible(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToDidBecomeVisible(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ...
  /** Opens a URL in the default browser */
  openUrl(request: StringRequest, callback: (error: ServiceError | null, response: Empty) => void): ClientUnaryCall;
  openUrl(
    request: StringRequest,
    metadata: Metadata,
    callback: (error: ServiceError | null, response: Empty) => void,
...
export const UiServiceClient = makeGenericClientConstructor(UiServiceService, "cline.UiService") as unknown as {
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): UiServiceClient;
  service: typeof UiServiceService;
  serviceName: string;
};
