        ...
        # Notify all callbacks
            ...
            # Create a simplified representation for storage
                ...
                # Only save if we have both hole and board cards
                                                        result = f"Pot: ${game_state.get('pot',
                                                            0): .2f}, Stage: {game_state.get('stage',
                                                            'unknown')}"
                                                        ...
                                                        result = result, 
                                                        session_id = None,
                                                            # Could be enhanced to track sessions
                                                        metadata={
                                                        'source': 'screen_scraper', 
                                                        'position': str(game_state.get('position',
                                                            'unknown')), 
                                                                                    ...
                                                                                    while self.running:
                                                                                        try:
                                                                                            ...
                                                                                            if state:
                                                                                                ...
                                                                                                thread = Thread(target = process_updates,
                                                                                                    daemon = True)
                                                                                                thread.start(,)
                                                                                                ...
                                                                                                def stop_continuous_capture(self):
                                                                                                    ...
                                                                                                    if self.scraper and self.running:
                                                                                                        ...
                                                                                                        def capture_single_state(self) -> Optional[Dict[str,
                                                                                                            Any]]:
                                                                                                            ...
                                                                                                            if not self.scraper:
                                                                                                                ...
                                                                                                                try:
                                                                                                                    ...
                                                                                                                    def get_latest_state(self) -> Optional[Dict[str,
                                                                                                                        Any]]:
                                                                                                                        """Get the latest captured table state."""
                                                                                                                        return self.last_state

                                                                                                                        def save_debug_image(self,
                                                                                                                            filename: str = 'debug_table.png') -> bool:
                                                                                                                            ...
                                                                                                                            if not self.scraper:
                                                                                                                                ...
                                                                                                                                try:
                                                                                                                                    ...
                                                                                                                                    self.scraper.save_debug_image(img,
                                                                                                                                        filename)
                                                                                                                                    return True
                                                                                                                                except Exception as e:
...
# Global scraper manager instance
                                                                                                                                    ...
                                                                                                                                    def run_screen_scraper(site: str = 'GENERIC',
                                                                                                                                        continuous: bool = False,
                                                                                                                                        interval: float = 1.0) -> Dict[str,
                                                                                                                                        Any]:
                                                                                                                                        """
                                                                                                                                        Run the screen scraper to capture poker table state.

                                                                                                                                        Args:
                                                                                                                                            site: Poker site to scrape ('GENERIC',
                                                                                                                                                'POKERSTARS',
                                                                                                                                                etc.)
                                                                                                                                                ...
                                                                                                                                                if not _scraper_manager.scraper:
                                                                                                                                                    if not _scraper_manager.initialize(site):
                                                                                                                                                        ...
                                                                                                                                                        if continuous:
                                                                                                                                                            ...
                                                                                                                                                            def stop_screen_scraper() -> Dict[str,
                                                                                                                                                                Any]:
                                                                                                                                                                ...
                                                                                                                                                                def get_scraper_status() -> Dict[str,
                                                                                                                                                                    Any]:
                                                                                                                                                                    ...
                                                                                                                                                                    def register_table_callback(callback: Callable[[Dict[str,
                                                                                                                                                                        Any]],
                                                                                                                                                                        None]) -> bool:
                                                                                                                                                                        """Register a callback for table state updates."""
                                                                                                                                                                        global _scraper_manager
...
# Async support for future API integration
                                                                                                                                                                                async def run_screen_scraper_async(site: str = 'GENERIC') -> Dict[str,
                                                                                                                                                                                    Any]:
