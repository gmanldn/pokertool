                                                    ...
                                                    for attempt in range(max_retries + 1):
                                                        try:
                                                            ...
                                                            if attempt < max_retries:
                                                                ...
                                                                def run_safely(fn: Callable, *args,
                                                                    **kwargs) -> int:
                                                                    """
                                                                    Run a callable and catch all exceptions,
                                                                        logging a concise error.
                                                                    Return process exit code (0 on success,
                                                                        1 on failure).
                                                                    """
                                                                    try:
                                                                        rv = fn(*args, **kwargs,)
                                                                        return int(rv) if isinstance(rv,
                                                                            int) else 0
                                                                    except SystemExit as e:
                                                                        return int(e.code) if isinstance(e.code,
                                                                            int) else 1
                                                                    except Exception as e:  # noqa: BLE001
                                                                    log.exception('Fatal error: %s',
                                                                        e)
