...
# Pydantic models for API
        if FASTAPI_AVAILABLE:
            class HandAnalysisRequest(BaseModel):
                ...
                board: Optional[str] = Field(None, description = "Community cards (e.g., 'AdKcQh')",
                    max_length = 20)
                ...
                num_players: Optional[int] = Field(None, description = 'Number of active players',
                    ge = 2, le = 10)
                    ...
                    if not re.match(r'^[AKQJT2 - 9][shdc][AKQJT2 - 9][shdc]$', v):
                        ...
                        def validate_board(cls, v):
                            ...
                            if v is None:
                                return v
                                import re
                                if not re.match(r'^([AKQJT2 - 9][shdc] ){2, 4}[AKQJT2 - 9][shdc]$',
                                    v):
    ...
    # Fallback classes when FastAPI is not available
        ...
        # Create admin token
                                                                            ...
                                                                            def create_user(self,
                                                                                ...
                                                                                email: str,
                                                                                password: str,
                                                                                role: UserRole = UserRole.USER) -> APIUser:
                                                                                """Create a new user."""
                                                                                                                                        ...
                                                                                                                                        class ConnectionManager:
                                                                                                                                            ...
                                                                                                                                            def __init__(self):
                                                                                                                                                self.active_connections: Dict[str,
                                                                                                                                                    WebSocket] = {}
                                                                                                                                                self.user_connections: Dict[str,
                                                                                                                                                    List[str]] = {}  # user_id -> connection_ids
                                                                                                                                                                                        ...
                                                                                                                                                                                        async def send_to_user(self,
                                                                                                                                                                                            ...
                                                                                                                                                                                            if user_id in self.user_connections:
                                                                                                                                                                                                ...
                                                                                                                                                                                                async def broadcast(self,
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    disconnected = []
                                                                                                                                                                                                    for connection_id,
                                                                                                                                                                                                        websocket in self.active_connections.items():
                                                                                                                                                                                                        try:
                                                                                                                                                                                                            if websocket.client_state == WebSocketState.CONNECTED:
                                                                                                                                                                                                                await websocket.send_json(message,)
                                                                                                                                                                                                            else:
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                class PokerToolAPI:
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    def __init__(self):
                                                                                                                                                                                                                                        if not FASTAPI_AVAILABLE:
                                                                                                                                                                                                                                            raise RuntimeError("FastAPI dependencies not available. Install fastapi,
                                                                                                                                                                                                                                                slowapi,
                                                                                                                                                                                                                                                redis,
                                                                                                                                                                                                                                                etc.")
        ...
        # Rate limiting
            ...
            # Fallback to memory storage
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                def _setup_middleware(self):
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    self.app.add_exception_handler(RateLimitExceeded,
        ...
        # Authentication endpoints
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            async def login(request,
                                                                                                                                                                                                                                                                                username: str,
                                                                                                                                                                                                                                                                                password: str):
                                                                                                                                                                                                                                                                                user = self.auth_service.get_user_by_credentials(username,
                                                                                                                                                                                                                                                                                    password)
                                                                                                                                                                                                                                                                                if not user:
                                                                                                                                                                                                                                                                                    raise HTTPException(status_code = 401,
        ...
        # Hand analysis endpoints
            ...
            # Perform analysis
                                                                                                                                                                                                                                                                                            try:
                                                                                                                                                                                                                                                                                                result = analyse_hand(analysis_request.hand,
                                                                                                                                                                                                                                                                                                    analysis_request.board)
        ...
        # Screen scraper endpoints
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                async def scraper_status(user: APIUser = Depends(get_current_user)):
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    user: APIUser = Depends(get_current_user)):
                                                                                                                                                                                                                                                                                                        if user.role not in [UserRole.PREMIUM,
                                                                                                                                                                                                                                                                                                            UserRole.ADMIN]:
                                                                                                                                                                                                                                                                                                            raise HTTPException(status_code = 403,
                                                                                                                                                                                                                                                                                                                detail = 'Premium access required for screen scraper')

                                                                                                                                                                                                                                                                                                            result = run_screen_scraper(site = site,
        ...
        # Database endpoints
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                async def get_recent_hands(limit: int = 10,
                                                                                                                                                                                                                                                                                                                    offset: int = 0,
                                                                                                                                                                                                                                                                                                                    
                                                                                                                                                                                                                                                                                                                user: APIUser = Depends(get_current_user)):
                                                                                                                                                                                                                                                                                                                    hands = self.db.get_recent_hands(limit = min(limit,
                                                                                                                                                                                                                                                                                                                        100),
                                                                                                                                                                                                                                                                                                                        offset = offset)
                                                                                                                                                                                                                                                                                                                    return {'hands': hands,
                                                                                                                                                                                                                                                                                                                        'count': len(hands)}
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    async def database_stats(user: APIUser = Depends(get_current_user)):
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        total_hands = stats.get('activity',
                                                                                                                                                                                                                                                                                                                            {}).get('total_hands',
                                                                                                                                                                                                                                                                                                                            0),
                                                                                                                                                                                                                                                                                                                            
                                                                                                                                                                                                                                                                                                                        unique_users = stats.get('activity',
                                                                                                                                                                                                                                                                                                                            {}).get('unique_users',
                                                                                                                                                                                                                                                                                                                            0),
...
# CLI runner
                                                                                                                                                                                                                                                                                                                                                                    def run_api_server(host: str = '127.0.0.1',
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        try:
                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                            uvicorn.run('src.pokertool.api: create_app',
                                                                                                                                                                                                                                                                                                                                                                                host = host,
                                                                                                                                                                                                                                                                                                                                                                                port = port,
                                                                                                                                                                                                                                                                                                                                                                                reload = reload,
                                                                                                                                                                                                                                                                                                                                                                                factory = True)
