...
# Import existing secure database for fallback
    ...
    # Security
        ...
        # Initialize based on database type
            ...
            # Remove None values
                                            conn_params = {k: v for k,
                                                v in conn_params.items() if v is not None}
                                                        ...
                                                        try:
                                                            ...
                                                            with self.sqlite_db._get_connection() as conn:
                                                                ...
                                                                def _create_postgresql_schema(self):
                                                                    ...
                                                                    -- Note: This would be implemented separately for production

                                                                    -- Statistics and monitoring views
                                                                    CREATE OR REPLACE VIEW hands_summary AS
                                                                    SELECT
                                                                    DATE_TRUNC('day',
                                                                        timestamp) as date, 
                                                                    ...
                                                                    -- Function for hand analysis stats
                                                                    CREATE OR REPLACE FUNCTION get_user_stats(user_hash_param VARCHAR(32),)
                                                                    RETURNS TABLE(
                                                                    total_hands BIGINT, 
                                                                    avg_pot_size NUMERIC, 
                                                                    most_common_position TEXT, 
                                                                    win_rate NUMERIC
                                                                    ) AS $$
                                                                    BEGIN
                                                                    RETURN QUERY
                                                                    ...
                                                                    0: : NUMERIC as avg_pot_size,
                                                                        -- Would extract from metadata
                                                                    'Unknown': : TEXT as most_common_position,
                                                                        
                                                                    0: : NUMERIC as win_rate
                                                                    FROM poker_hands
                                                                    WHERE poker_hands.user_hash = user_hash_param
                                                                    END
                                                                    $$ LANGUAGE plpgsql
                                                                    """
                                                                        ...
                                                                        with conn.cursor() as cursor:
                                                                            ...
                                                                            def _rate_limit_check(self,
                                                                                ...
                                                                                if operation not in self.rate_limiter:
                                                                                    ...
                                                                                    count = self.rate_limiter[operation].get(minute_window,
                                                                                        0)
        ...
        # Clean old entries
                                                                                        ...
                                                                                        for w in old_windows:
                                                                                            ...
                                                                                            def _generate_user_hash(self) -> str:
                                                                                                ...
                                                                                                import platform
                                                                                                user_info = f"{platform.node()}{os.getenv('USER',
                                                                                                    'anonymous')}{int(time.time() // 3600)}"
                                                                                                return hashlib.sha256(user_info.encode()).hexdigest()[: 16]

                                                                                                @retry_on_failure(max_retries = 3,)
                                                                                                def save_hand_analysis(self,
                                                                                                    hand: str,
                                                                                                    board: Optional[str],
                                                                                                    result: str,
                                                                                                ...
                                                                                                session_id: Optional[str] = None,
                                                                                                    ...
                                                                                                    self._rate_limit_check('save_hand',
                                                                                                        50)

                                                                                                    from .error_handling import sanitize_input

        # Sanitize inputs
                                                                                                    hand = sanitize_input(hand,
                                                                                                        max_length = 50)
                                                                                                    if board:
                                                                                                            ...
                                                                                                            if self.config.db_type == DatabaseType.POSTGRESQL:
                                                                                                                with self.get_connection() as conn:
                                                                                                                    with conn.cursor() as cursor:
                                                                                                                        ...
                                                                                                                        return self.sqlite_db.save_hand_analysis(hand,
                                                                                                                            board,
                                                                                                                            result,
                                                                                                                            session_id)
                                                                                                                        ...
                                                                                                                        def get_recent_hands(self,
                                                                                                                            ...
                                                                                                                            """TODO: Add docstring."""
                                                                                                                        user_hash: Optional[str] = None) -> List[Dict[str,
                                                                                                                            Any]]:
                                                                                                                            """Get recent hands with enhanced filtering."""
                                                                                                                            self._rate_limit_check('get_hands',
                                                                                                                                200)
                                                                                                                                    ...
                                                                                                                                    with self.get_connection() as conn:
                                                                                                                                        with conn.cursor(cursor_factory = RealDictCursor) as cursor:
                                                                                                                                            if user_hash:
                                                                                                                                                ...
                                                                                                                                                return self.sqlite_db.get_recent_hands(limit,
                                                                                                                                                    offset)

                                                                                                                                                def create_session(self,
                                                                                                                                                    notes: Optional[str] = None,
                                                                                                                                                    metadata: Optional[Dict] = None) -> str:
                                                                                                                                                    """Create game session with metadata support."""
                                                                                                                                                            ...
                                                                                                                                                            if self.config.db_type == DatabaseType.POSTGRESQL:
                                                                                                                                                                with self.get_connection() as conn:
                                                                                                                                                                    with conn.cursor() as cursor:
                                                                                                                                                                        ...
                                                                                                                                                                        return self.sqlite_db.create_session(notes,)

                                                                                                                                                                        return session_id

                                                                                                                                                                        def get_database_stats(self) -> Dict[str,
                                                                                                                                                                            Any]:
                        ...
                        # Get recent activity
                                                                                                                                                                                            ...
                                                                                                                                                                                            'current_connections': len(self.connection_pool._pool) if hasattr(self.connection_pool,
                                                                                                                                                                                                '_pool') else 0
                                                                                                                                                                                            }
                                                                                                                                                                                            }
                                                                                                                                                                                        else:
        ...
        # Create temporary SQLite connection
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                with pg_conn.cursor() as pg_cursor:
                                                                                                                                                                                                                    for row in cursor:
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        if migrated_count % 1000 == 0:
                                                                                                                                                                                                                            pg_conn.commit(,)
                                                                                                                                                                                                                            logger.info(f'Migrated {migrated_count} hands...',)
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            with self.get_connection() as pg_conn:
                                                                                                                                                                                                                                with pg_conn.cursor() as pg_cursor:
                                                                                                                                                                                                                                    for row in cursor:
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        logger.info(f"Migration completed: {migrated_count} hands migrated",)
            ...
            # Use pg_dump for PostgreSQL
                                                                                                                                                                                                                                                if backup_path is None:
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    backup_path = f'pokertool_backup_{timestamp}.sql'
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    if self.config.password:
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        if result.returncode != 0:
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            return self.sqlite_db.backup_database(backup_path,)
...
# Global instance management
        ...
        # Force PostgreSQL configuration
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    host = os.getenv('POKER_DB_HOST',
                                                                                                                                                                                                                                                                                        'localhost'),
                                                                                                                                                                                                                                                                                        
                                                                                                                                                                                                                                                                                    port = int(os.getenv('POKER_DB_PORT',
                                                                                                                                                                                                                                                                                        '5432')),
                                                                                                                                                                                                                                                                                        
                                                                                                                                                                                                                                                                                    database = os.getenv('POKER_DB_NAME',
                                                                                                                                                                                                                                                                                        'pokertool'),
                                                                                                                                                                                                                                                                                        
                                                                                                                                                                                                                                                                                    user = os.getenv('POKER_DB_USER',
                                                                                                                                                                                                                                                                                        'postgres'),
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    migrated_count = prod_db.migrate_from_sqlite(sqlite_path,)
