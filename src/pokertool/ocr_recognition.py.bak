...
"""
OCR Card Recognition Module
Provides optical character recognition for poker cards from screen captures.
Integrates with the screen scraper to identify cards, betting amounts, and player actions.
"""
