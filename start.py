                        ...
                        def initialize_logging() -> None:
                            ...
                            def cleanup() -> None:
                                ...
                                def _log_cmd(args: list[str]) -> str:
                                    ...
                                    def _detect_scanner_flags(python: str, script: Path) -> dict[str,
                                        bool]:
                                        """
                                        Probe 'code_scan.py --help' and detect available flags.
                                        Returns a dict of supported flags (path, dry_run,
                                            no_backup).
                                        """
                                        supported = {'path': False, 'dry_run': False,
                                            'no_backup': False}
                                        try:
