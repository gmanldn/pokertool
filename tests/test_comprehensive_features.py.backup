...
try:
    ...
    from pokertool.database import ProductionDatabase, DatabaseConfig, DatabaseType, migrate_to_production
...
class TestDatabaseMigration(unittest.TestCase):
    ...
    def test_production_database_get_recent_hands(self):
        ...
        # Add test data
        db.save_hand_analysis("AsKh", "7d 8d 9c", "Test 1")
        db.save_hand_analysis("KdQh", "Tc Jc Qs", "Test 2")
...
class TestAPIFeatures(unittest.TestCase):
    ...
    def test_authentication_service_duplicate_user(self):
        ...
        with self.assertRaises(Exception):  # Should raise HTTPException, but we'll catch any exception
